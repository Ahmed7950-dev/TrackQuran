              ...
              return (
                ...
                >
                  ...
                  <div className="pt-3 px-2 flex items-end justify-center gap-1" style={{ width: 110, height: 110 }}>
                    <img src="/sprites/race-runner-down.png" alt="" className="h-20 w-auto object-contain" />
                    <img src="/sprites/race-runner-down.png" alt="" className="h-20 w-auto object-contain" style={{ filter: 'hue-rotate(165deg)' }} />
                  </div>
                  <div className="pb-3 px-3 w-full text-center">
