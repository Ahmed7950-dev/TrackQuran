...
const AirplaneGame: React.FC<AirplaneGameProps> = ({
  ...
  // Client-side prediction (P2 view): P2 simulates its OWN plane locally for
  ...
  // P2 simulates its OWN plane locally from its own keys (instant control) and
  // reconciles to the host's authoritative snapshots; P1's plane is interpolated
  // toward the latest snapshot for smooth 60fps motion. Host stays authoritative
  // for collisions, fuel and scoring.
  useEffect(() => {
