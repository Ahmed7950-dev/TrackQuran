    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isSignUp) {
                ...
                const result = await signup(teacherName, email, password);
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {isSignUp && (
                            <div>
                                ...
                                <input id="name" type="text" required value={teacherName} onChange={e => setTeacherName(e.target.value)}
                    ...
                    <div className="mt-6">
                        <button onClick={handleGoogleSignIn} disabled={loading}
                            ...
                            <svg className="w-5 h-5 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 381.5 512 244 512 109.8 512 0 402.2 0 261.8 0 120.5 109.8 11.8 244 11.8c70.4 0 129.5 27.1 175.4 69.1l-63.1 61.9C333.1 119.3 293.8 98.2 244 98.2c-76.4 0-138.3 61.9-138.3 138.3s61.9 138.3 138.3 138.3c88.1 0 112.3-63.7 115.5-98.2H244v-72h244z"/></svg>
