...
const rowToStudent = (row: any): Student => ({
  ...
  billStudentName:             row.bill_student_name            ?? undefined,
  ...
  billDurations:               row.bill_durations               ?? undefined,
...
const studentToRow = (teacherId: string, s: Student) => ({
  ...
  bill_student_name:           s.billStudentName ?? null,
  ...
  bill_durations:              s.billDurations ?? null,
